...
export default function DashboardNav({ restaurantName, restaurantSlug, role, userEmail }: Props) {
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-64 flex-col border-r border-gray-800 bg-gray-900">
      ...
      <nav className="flex-1 space-y-1 p-3">
        ...
        {/* Lien vers la vitrine publique */}
        {restaurantSlug && (
          <a
            href={`/${restaurantSlug}`}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-gray-400 transition-all hover:bg-gray-800 hover:text-white"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="border-t border-gray-800 p-4">
        ...
        <button
          ...
          className="flex w-full items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium text-gray-400 transition-all hover:bg-red-500/10 hover:text-red-400"
        >
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
